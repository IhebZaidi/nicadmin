...
$tdatafsi[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatafsi[".originalPagesByType"] = $tdatafsi[".pagesByType"];
$tdatafsi[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatafsi[".originalPages"] = $tdatafsi[".pages"];
$tdatafsi[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"edit\":\"edit\",\"export\":\"export\",\"import\":\"import\",\"list\":\"list\",\"masterlist\":\"masterlist\",\"masterprint\":\"masterprint\",\"print\":\"print\",\"search\":\"search\",\"view\":\"view\"}" );
...
{
	$fieldLabelsfsi["English"] = array();
	$fieldToolTipsfsi["English"] = array();
	$placeHoldersfsi["English"] = array();
	$pageTitlesfsi["English"] = array();
	$fieldLabelsfsi["English"]["id_fsi"] = "Id Fsi";
	$fieldToolTipsfsi["English"]["id_fsi"] = "";
	$placeHoldersfsi["English"]["id_fsi"] = "";
	$fieldLabelsfsi["English"]["nom"] = "Nom";
	$fieldToolTipsfsi["English"]["nom"] = "";
	$placeHoldersfsi["English"]["nom"] = "";
	$fieldLabelsfsi["English"]["adresse"] = "Adresse";
	$fieldToolTipsfsi["English"]["adresse"] = "";
	$placeHoldersfsi["English"]["adresse"] = "";
	$fieldLabelsfsi["English"]["tel"] = "Tel";
	$fieldToolTipsfsi["English"]["tel"] = "";
	$placeHoldersfsi["English"]["tel"] = "";
	$fieldLabelsfsi["English"]["fax"] = "Fax";
	$fieldToolTipsfsi["English"]["fax"] = "";
	$placeHoldersfsi["English"]["fax"] = "";
	$fieldLabelsfsi["English"]["email"] = "Email";
	$fieldToolTipsfsi["English"]["email"] = "";
	$placeHoldersfsi["English"]["email"] = "";
	$fieldLabelsfsi["English"]["prim_email"] = "Prim Email";
	$fieldToolTipsfsi["English"]["prim_email"] = "";
	$placeHoldersfsi["English"]["prim_email"] = "";
	$fieldLabelsfsi["English"]["sec_email"] = "Sec Email";
	$fieldToolTipsfsi["English"]["sec_email"] = "";
	$placeHoldersfsi["English"]["sec_email"] = "";
	$fieldLabelsfsi["English"]["allowed_IPs"] = "Allowed IPs";
	$fieldToolTipsfsi["English"]["allowed_IPs"] = "";
	$placeHoldersfsi["English"]["allowed_IPs"] = "";
	$fieldLabelsfsi["English"]["url"] = "Url";
	$fieldToolTipsfsi["English"]["url"] = "";
	$placeHoldersfsi["English"]["url"] = "";
	$fieldLabelsfsi["English"]["login"] = "Login";
	$fieldToolTipsfsi["English"]["login"] = "";
	$placeHoldersfsi["English"]["login"] = "";
	$fieldLabelsfsi["English"]["password"] = "Password";
	$fieldToolTipsfsi["English"]["password"] = "";
	$placeHoldersfsi["English"]["password"] = "";
	$fieldLabelsfsi["English"]["API_password"] = "API Password";
	$fieldToolTipsfsi["English"]["API_password"] = "";
	$placeHoldersfsi["English"]["API_password"] = "";
	$fieldLabelsfsi["English"]["password_reset_token"] = "Password Reset Token";
	$fieldToolTipsfsi["English"]["password_reset_token"] = "";
	$placeHoldersfsi["English"]["password_reset_token"] = "";
	$fieldLabelsfsi["English"]["password_reset_token_expire"] = "Password Reset Token Expire";
	$fieldToolTipsfsi["English"]["password_reset_token_expire"] = "";
	$placeHoldersfsi["English"]["password_reset_token_expire"] = "";
	$fieldLabelsfsi["English"]["secret_pass"] = "Secret Pass";
	$fieldToolTipsfsi["English"]["secret_pass"] = "";
	$placeHoldersfsi["English"]["secret_pass"] = "";
	$fieldLabelsfsi["English"]["commentaires"] = "Commentaires";
	$fieldToolTipsfsi["English"]["commentaires"] = "";
	$placeHoldersfsi["English"]["commentaires"] = "";
	$fieldLabelsfsi["English"]["date_modif"] = "Date Modif";
	$fieldToolTipsfsi["English"]["date_modif"] = "";
	$placeHoldersfsi["English"]["date_modif"] = "";
	$fieldLabelsfsi["English"]["nomnoc"] = "Nomnoc";
	$fieldToolTipsfsi["English"]["nomnoc"] = "";
	$placeHoldersfsi["English"]["nomnoc"] = "";
	$fieldLabelsfsi["English"]["admin"] = "Admin";
	$fieldToolTipsfsi["English"]["admin"] = "";
	$placeHoldersfsi["English"]["admin"] = "";
	$fieldLabelsfsi["English"]["etat"] = "Etat";
	$fieldToolTipsfsi["English"]["etat"] = "";
	$placeHoldersfsi["English"]["etat"] = "";
	$fieldLabelsfsi["English"]["prefix"] = "Prefix";
	$fieldToolTipsfsi["English"]["prefix"] = "";
	$placeHoldersfsi["English"]["prefix"] = "";
	$fieldLabelsfsi["English"]["langue"] = "Langue";
	$fieldToolTipsfsi["English"]["langue"] = "";
	$placeHoldersfsi["English"]["langue"] = "";
	$fieldLabelsfsi["English"]["accountBalance"] = "Account Balance";
	$fieldToolTipsfsi["English"]["accountBalance"] = "";
	$placeHoldersfsi["English"]["accountBalance"] = "";
	$fieldLabelsfsi["English"]["creditLimit"] = "Credit Limit";
	$fieldToolTipsfsi["English"]["creditLimit"] = "";
	$placeHoldersfsi["English"]["creditLimit"] = "";
	$fieldLabelsfsi["English"]["creditThreshold"] = "Credit Threshold";
	$fieldToolTipsfsi["English"]["creditThreshold"] = "";
	$placeHoldersfsi["English"]["creditThreshold"] = "";
	$fieldLabelsfsi["English"]["thresholdType"] = "Threshold Type";
	$fieldToolTipsfsi["English"]["thresholdType"] = "";
	$placeHoldersfsi["English"]["thresholdType"] = "";
	$fieldLabelsfsi["English"]["mgmt"] = "Mgmt";
	$fieldToolTipsfsi["English"]["mgmt"] = "";
	$placeHoldersfsi["English"]["mgmt"] = "";
