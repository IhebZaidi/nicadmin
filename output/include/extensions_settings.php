...
{
	$fieldLabelsextensions["English"] = array();
	$fieldToolTipsextensions["English"] = array();
	$placeHoldersextensions["English"] = array();
	$pageTitlesextensions["English"] = array();
	$fieldLabelsextensions["English"]["id"] = "Id";
	$fieldToolTipsextensions["English"]["id"] = "";
	$placeHoldersextensions["English"]["id"] = "";
	$fieldLabelsextensions["English"]["nom"] = "Nom";
	$fieldToolTipsextensions["English"]["nom"] = "";
	$placeHoldersextensions["English"]["nom"] = "";
	$fieldLabelsextensions["English"]["commentaires"] = "Commentaires";
	$fieldToolTipsextensions["English"]["commentaires"] = "";
	$placeHoldersextensions["English"]["commentaires"] = "";
	$fieldLabelsextensions["English"]["nom_script"] = "Nom Script";
	$fieldToolTipsextensions["English"]["nom_script"] = "";
	$placeHoldersextensions["English"]["nom_script"] = "";
	$fieldLabelsextensions["English"]["upd"] = "Upd";
	$fieldToolTipsextensions["English"]["upd"] = "";
	$placeHoldersextensions["English"]["upd"] = "";
